...
const mockIdentifierTypes = [
  {
    ...
    description: 'OpenMRS ID description',
  },
  {
    fieldName: 'idCard',
    format: '',
  ...
  },
  {
    ...
    description: 'Legacy ID description',
  },
  {
    ...
    description: 'Old Identification Number description',
  },
  {
    ...
    description: 'OpenMRS Identification Number description',
  },
];
